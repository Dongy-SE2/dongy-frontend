        ...
        <div className="flex justify-center">
          ...
          <div className="relative px-9">
            ...
            <div className="relative w-[385px] h-[221px]">
              ...
              />
              <div className="absolute top-2 left-2 bg-[#10B981] px-2 py-1 rounded-lg flex align-middle items-center space-x-1">
                <div className="bg-white rounded-full w-3 h-3"/>
                <div className="text-white text-base ">LIVE</div>
              </div>
            </div>
            {/* Bottom Left: Live Info Card */}
            <div className="w-[385px] h-[144px] mt-4 p-4 bg-white rounded-lg shadow text-center">
              ...
              <p className="text-base text-gray-600">การประมูลจะสิ้นสุดในอีก 2 ชม.</p>
