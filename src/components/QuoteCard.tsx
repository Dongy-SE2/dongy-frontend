  ...
  return (
    ...
    <div className="w-[623px] h-[136px] p-2">
        <div className="relative">
            <div className="animate-bounce absolute -left-1 -top-5 size-[69px] bg-gradient-to-b from-[#129587] to-[#77A97E] opacity-50 rounded-full"></div>
            ...
            <div className="flex w-full h-full bg-[#EAEAEA] opacity-80 rounded-[10px] m-4 p-4 pr-8 align-middle border-2 border-white backdrop-blur-xl"> 
                <img 
                    src="/image/ceo.jpg"
                    alt="CEO"
